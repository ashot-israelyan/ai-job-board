...
function getColumns(canUpdateRating: boolean, canUpdateStage: boolean): ColumnDef<Application>[] {
  return [
    ...
    {
      accessorKey: 'stage',
      header: ({ column }) => <DataTableSortableColumnHeader title="Stage" column={column} />,
    ...
    {
      accessorKey: 'rating',
      header: ({ column }) => <DataTableSortableColumnHeader title="Rating" column={column} />,
      filterFn: ({ original }, _, value) => {
    ...
    },
    {
      ...
      header: ({ column }) => <DataTableSortableColumnHeader title="Applied On" column={column} />,
    ...
    <div className="flex items-center gap-2">
      {table.getColumn('stage') && (
        <DataTableFacetedFilter
          ...
          title="Stage"
          options={applicationStages.toSorted(sortApplicationsByStage).map((stage) => ({
